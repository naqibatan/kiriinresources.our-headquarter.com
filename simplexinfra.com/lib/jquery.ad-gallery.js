...
(function ($) {
  ...
  AdGallery.prototype = {
    ...
    init: function (wrapper, settings) {
      ...
      this.slideshow = new AdGallerySlideshow(
        nextimage_callback,
    ...
    setupElements: function () {
      ...
      this.loader = $(
        '<img class="ad-loader" src="' + this.settings.loader_image + '">'
      );
    ...
    _createImageData: function (thumb_link, image_src) {
      ...
      if (thumb_img.data("ad-link")) {
        ...
        thumb_img.attr("longdesc") &&
        thumb_img.attr("longdesc").length
      ) {
    ...
    removeImage: function (index) {
      ...
      this.gallery_info.html(
        this.current_index + 1 + " / " + this.images.length
      );
    ...
    _getDescription: function (image) {
      ...
      if (image.desc.length || image.title.length) {
        ...
        if (image.title.length) {
          title = '<strong class="title">' + image.title + "</strong>";
        }
        var desc = "";
        if (image.desc.length) {
          desc = "<span>" + image.desc + "</span>";
        }
        desc = $('<p class="description">' + title + desc + "</p>");
      }
      return desc;
    },
    /**
    ...
    _showWhenLoaded: function (index, callback) {
      if (this.images[index]) {
        ...
        var size = this._getContainedImageSize(
          image.size.width,
          image.size.height
        );
        ...
        if (desc) {
          if (
            !this.settings.description_wrapper &&
            !this.settings.hooks.displayDescription
          ) {
    ...
    highLightThumb: function (thumb) {
      ...
      if (this.settings.thumb_opacity < 1) {
        this.thumbs_wrapper
          .find("a:not(.ad-active) img")
          .fadeTo(300, this.settings.thumb_opacity);
  ...
  AdGallerySlideshow.prototype = {
    ...
    create: function () {
      this.start_link = $(
        '<span class="ad-slideshow-start">' +
          this.settings.start_label +
          "</span>"
      );
      this.stop_link = $(
        '<span class="ad-slideshow-stop">' +
          this.settings.stop_label +
          "</span>"
      );
      this.countdown = $('<span class="ad-slideshow-countdown"></span>');
      this.controls = $('<div class="ad-slideshow-controls"></div>');
      this.controls
        .append(this.start_link)
        .append(this.stop_link)
