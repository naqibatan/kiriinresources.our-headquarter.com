...
*/
    ...
    _.Xa = function (a) {
      return a instanceof _.Sb && a.constructor === _.Sb
        ? a.g
    ...
    _.cc = Array.prototype.lastIndexOf
      ? function (a, b) {
    ...
    _.cd = function (a) {
      return a instanceof _.bd && a.constructor === _.bd
        ? a.g
        : "type_error:SafeHtml";
    };
    ...
    _.Ed = function (a, b) {
      ...
      if (a) {
        ...
        d
          ...
          : ((this.offsetX =
              _.vc || void 0 !== a.offsetX ? a.offsetX : a.layerX),
            (this.offsetY =
              _.vc || void 0 !== a.offsetY ? a.offsetY : a.layerY),
    ...
    Kd.prototype.add = function (a, b, c, d, e) {
      ...
      -1 < g
        ? ((b = a[g]), c || (b.Ud = !1))
        : ((b = new Id(b, this.src, f, !!d, e)), (b.Ud = c), a.push(b));
      return b;
    };
    ...
    var Ld = function (a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];
        if (!f.Ed && f.listener == b && f.capture == !!c && f.me == d) return e;
      }
      return -1;
    };
    ...
    _.Yd = function (a, b, c, d, e) {
      if (Array.isArray(b))
        ...
        (d = _.xa(d) ? !!d.capture : !!d),
          ...
          _.Gd(a)
            ? a.vb(b, c, d, e)
            : a && (a = _.Ud(a)) && (b = a.wd(b, c, d, e)) && _.Zd(b);
    };
    _.Zd = function (a) {
      if ("number" === typeof a || !a || a.Ed) return !1;
      var b = a.src;
      if (_.Gd(b)) return Md(b.fb, a);
      var c = a.type,
        d = a.proxy;
    ...
    _.H.prototype.wd = function (a, b, c, d) {
      return this.fb.wd(String(a), b, c, d);
    };
...
*/
    ...
    var Ue = function (a) {
      ...
      Me = function (a) {
        ...
        d &&
          ((h = (0, _.A)(a.H, a, !0)),
          (d = (0, _.A)(a.H, a, !1)),
          b instanceof Je ? (Pe(b, h, d), (b.ia = !0)) : b.then(h, d));
    ...
    yb.Za = Xe;
    yb.Za.g = { Cg: 0, qg: 1, TIMEOUT: 2, Ag: 3, Ne: 4 };
    var Ze = function () {
      $b.call(this);
      this.g = {};
      this.l = [];
    ...
    _.k.Zf = function (a, b) {
      if (!(this instanceof Ze)) this.Zf(a, b);
        ...
        for (var c = [], d = 0; d < a.length; d++) {
          ...
          this.g[f]
            ? ((f = this.g[f].h),
              f != e && f.splice.apply(f, [0, f.length].concat(_.gb(e))))
            : (this.g[f] = new Xb(e, f));
        }
        b && b.length
      ...
      if (0 !== e.length) {
        ...
        a = (0, _.A)(this.B.H, this.B, _.va(e), this.g, {
          ...
          Lf: function (f) {
            ...
            401 == f
              ? (hf(d, new yb.Za(yb.Za.g.Cg, f)), (d.h.length = 0))
              : 410 == f
              ? (jf(d, new yb.Za(yb.Za.g.Ag, f)), kf(d))
              : 3 <= d.F
              ? (jf(d, new yb.Za(yb.Za.g.qg, f)), kf(d))
              : d.O(d.o, !0, 8001 == f);
          },
    ...
    var gf = function (a, b) {
      ...
      af = function (a) {
        a.j == a.D &&
          ((a.j = null),
          a.D.onLoad((0, _.A)(a.Yg, a)) && hf(a, new yb.Za(yb.Za.g.Ne)),
          cf(a));
      },
      oa = function (a) {
        if (a.j) {
          ...
          a.Bb() ||
            (a.g[b].onLoad((0, _.A)(a.Yg, a)) && hf(a, new yb.Za(yb.Za.g.Ne)),
            _.ua(a.A, b),
            _.ua(a.l, b),
            0 === a.l.length && kf(a),
    ...
    Ze.prototype.Sh = function (a) {
      this.j ||
        ((this.g.synthetic_module_overhead = new Xb(
          [],
    ...
    Ze.prototype.ga = function () {
      jf(this, new yb.Za(yb.Za.g.TIMEOUT));
      kf(this);
    };
    var jf = function (a, b) {
        1 < a.o.length
    ...
    _.vf.prototype.delete = function (a) {
      return Af(this.h, a)
        ? (delete this.h[a],
          --this.size,
          this.j++,
          this.g.length > 2 * this.size && zf(this),
          !0)
        : !1;
    };
    var zf = function (a) {
    ...
    _.Ff = function (a, b, c) {
      if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);
        ...
        for (var d = _.Ef(a), e = _.Df(a), f = e.length, g = 0; g < f; g++)
    ...
    _.vg = function (a, b, c) {
      a.remove(b);
      0 < c.length &&
        ((a.j = null), a.g.set(tg(a, b), _.va(c)), (a.h += c.length));
    };
    ...
    _.Fg.prototype.Oa = function (a) {
      ...
      this.h(
        null,
        "function" == typeof _.Gg && a instanceof _.Gg ? a.Kb : null
      );
    };
        ...
        nh(this),
          0 < this.o &&
            ((this.I = oh(this.g))
              ...
              : (this.B = _.hh(this.U, this.o, this))),
          (this.A = !0),
          this.g.send(a),
          (this.A = !1);
      } catch (g) {
    ...
    _.ih.prototype.V = function () {
      this.Bb() || (this.M || this.A || this.j ? rh(this) : this.ga());
    };
    ...
    _.ih.prototype.yd = function () {
      ...
      if (!b) {
        if ((a = 0 === a))
          (a = String(this.s).match(_.Xf)[1] || null),
            !a &&
              _.t.self &&
              _.t.self.location &&
              (a = _.t.self.location.protocol.slice(0, -1)),
            (a = !jh.test(a ? a.toLowerCase() : ""));
        b = a;
      }
      return b;
    };
    ...
    Lf({
      ...
      initialize: function (a) {
        ...
        !e &&
          ...
          ((e = f.src ? f.src : f.getAttribute("href")), (e = Gh(e)));
        e || (e = Gh(Kh));
        e ||
          ((e = document.getElementsByTagName("script")),
          (e = Gh(e[e.length - 1].src)));
        if (!e) throw Error("ba");
        e = new uh(e);
        c && (e.o = c);
        d && (e.l = d);
    ...
    _._ModuleManager_initialize(
      "b/sy0/sy1/sy2/rJmJrc:1,2,3/n73qwf/UUJqVe/MpJwZc/GHAeAc/sy3/sy4:9/sy5/Wt6vjf:2,a,b/sy6:1/byfTOb:d/sy7:a/sy8/sy9/LEikZe:2,3,d,f,g,h/lsjVmc:f,g/sya/el_conf:k/el_main_css/syc/syd:9,n/sye/el_main:b,f,h,k,m,o,p/corsproxy/website_error/syf/navigationui:a,n,p,t/phishing_protection:t/_stam:o",
      ["sya", "el_conf"]
    );
  } catch (e) {
    _._DumpException(e);
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.en_GB.n_Zr-VPSp2c.O/am=CAM/d=1/rs=AN8SPfo2_ByFWSufuy-Jup4hPwL7hFSymw/m=el_conf
// Configure Constants
(function () {
  ...
  (function () {
    ...
    c._ps =
      "https://www.gstatic.com/_/translate_http/_/ss/k\x3dtranslate_http.tr.qhDXWpKopYk.L.W.O/am\x3dCAM/d\x3d0/rs\x3dAN8SPfqeKn8wA30q4viup18yaci8udUjKQ/m\x3del_main_css";
    c._plla = oph + "/v1/supportedLanguages";
    c._puh = "translate.google.com";
    c._cnal = {};
    _loadCss(c._ps);
    _loadJs(
      "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.en_GB.n_Zr-VPSp2c.O/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfoRnYIRy4uT5osAMgPJBaJlidisow/m\x3del_main"
    );
    _exportMessages();
    _exportVersion("TE_20231106");
  })();
})();
